...
export function ContactSalesModal({ open, onOpenChange }) {
  ...
  return (
    ...
    >
      <div className="bg-card border border-border rounded-lg shadow-xl max-w-lg w-full p-6 mx-4 max-h-[90vh] overflow-y-auto text-foreground" onClick={(e) => e.stopPropagation()}>
        ...
        {success ? (
          <div className="py-6 text-center">
            ...
            <Button onClick={handleClose} className="mt-4 bg-gold-gradient hover:brightness-110 text-primary-foreground font-semibold cursor-pointer">
              Close
            </Button>
          </div>
        ) : step === 1 ? (
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="mt-1 w-full rounded-md border border-border bg-background px-3 py-2 text-sm text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-gold-solid/40 focus:border-transparent"
            ...
            <div>
              <label className="block text-sm font-medium text-muted-foreground mb-1">Company&apos;s website *</label>
              <input
                type="url"
            ...
            <div className="flex justify-end pt-2">
              <Button onClick={handleNext} className="gap-2 bg-gold-gradient hover:brightness-110 text-primary-foreground font-semibold cursor-pointer shadow-md">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-end gap-2 pt-2">
              <Button variant="outline" onClick={() => setStep(1)} className="border-border text-foreground hover:bg-secondary cursor-pointer">
                Back
              </Button>
              <Button onClick={handleSubmit} disabled={submitting} className="gap-2 bg-gold-gradient hover:brightness-110 text-primary-foreground font-semibold cursor-pointer shadow-md">
