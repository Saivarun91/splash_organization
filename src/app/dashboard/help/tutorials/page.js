...
export default function TutorialsPage() {
    ...
    return (
        <div className="space-y-6 animate-fade-in p-8">
            <div>
                <h1 className="text-3xl font-bold text-gray-900 mb-2">Tutorials & Walkthroughs</h1>
                <p className="text-gray-600">Learn how to get the most out of Splash AI Studio</p>
            </div>
